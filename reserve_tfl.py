...
​
        self.driver = webdriver.Chrome(install)
​
    def teardown(self):
        self.driver.quit()
​
...
​
        while not RESERVATION_FOUND:
            ...
            self.driver.get("https://www.exploretock.com/sanhowon/search?date=%s-%s-02&size=%s&time=%s" % (RESERVATION_YEAR, month_num(RESERVATION_MONTH), RESERVATION_SIZE, "22%3A00"))
...
​
    def login_tock(self):
        self.driver.get("https://www.exploretock.com/sanhowon/login")
